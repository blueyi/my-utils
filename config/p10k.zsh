# Repo: config/p10k.zsh → symlink ~/.p10k.zsh (common/link.ini). Regenerate: p10k configure, then copy here.
#
# Generated by Powerlevel10k configuration wizard on 2026-04-04 at 14:07 HKT.
...
# sharp heads, flat tails, 2 lines, dotted, left frame, lightest-ornaments, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # pyenv                 # deprecated — use uv (see resetrc.bash SECTION: uv)
