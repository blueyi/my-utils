...
# local-llm unified CLI (`lm`): local LLM / image-gen stack
# canonical cross-machine path: ~/workspace/repos/local-llm (legacy: ~/workspace/local-llm)
_path_add "$HOME/workspace/repos/local-llm/bin"
